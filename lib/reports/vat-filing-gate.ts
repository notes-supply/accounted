...
// Re-export the dependency-free account source to preserve the filing gate's
// public API without creating a cycle with the per-voucher gap scanner.
export { RC_BASIS_ACCOUNTS_BY_RATE } from './rc-basis-accounts'
